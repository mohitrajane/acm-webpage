    ...
    render(){
        ...
        <div className="bg-gray-200 text-blue-600">
            ...
            <div className="flex flex-wrap justify-center text-blue-600 py-2">
                ...
                <div className="md:px-2 py-2 lg:px-2 py-2 w-64">
                    <div className="max-w-sm rounded overflow-hidden bg-gray-100 shadow-lg">
                        <img className="w-full" src="images/nandhini.jpg" alt="Nandini"/>
                        <div className="px-6 py-4">
                ...
                <div className="md:px-2 py-2 lg:px-2 py-2 w-64">
                    <div className="max-w-sm rounded overflow-hidden bg-gray-100 shadow-lg">
                        <img className="w-full" src="images/yadhu.jpeg" alt="Yadhu"/>
                        <div className="px-6 py-4">
                            <div className="font-bold text-xl mb-2">Yadhu</div>
                ...
                <div className="md:px-2 py-2 lg:px-2 py-2 w-64">
                    <div className="max-w-sm rounded overflow-hidden bg-gray-100 shadow-lg">
                        <img className="w-full" src="images/sandeep.jpg" alt="Sandeep"/>
                        <div className="px-6 py-4">
