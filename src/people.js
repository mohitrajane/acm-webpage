            ...
            <div class="flex flex-wrap text-blue-600">
                ...
                <div class="lg:p-4 w-1/6">
                    <div class="max-w-sm rounded overflow-hidden bg-gray-100 shadow-lg">
                        ...
                        <div class="px-6 py-4">
                            <span class="inline-block bg-gray-200 rounded-full px-3 py-1 text-sm font-semibold text-gray-700 mr-2"><AiFillGitlab/></span>
                            <span class="inline-block bg-gray-200 rounded-full px-3 py-1 text-sm font-semibold text-gray-700"><AiFillLinkedin/></span>
                        </div>
                    </div>
                </div>
                {/*card 1 ends here*/}
